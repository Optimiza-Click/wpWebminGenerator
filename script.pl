...
{
return "Instala un WP. Luis David acuerdate, esta en el directorio virtual-server/scripts/custompress.pl";
}

sub get_the_last_version
{
...
local @files = ( { 'name' => "source",
	   ...
	   'url' => "https://es.wordpress.org/wordpress-5.2.2-es_ES.zip",
	   'virtualmin' => 0,
	   'nocache' => 1 } );
return @files;
}
...
{
local ($ver) = @_;
return ( "http://es.wordpress.org/download/",
	 "Version\\s+([0-9\\.]+)" );
}

sub script_custompress_site
{
return 'http://es.wordpress.org/';
}
